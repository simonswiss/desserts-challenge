...
<div class="bg-white p-6 rounded-lg">
      ...
      <li class="py-4 flex items-center justify-between gap-4 border-b border-zinc-200">
         <div>
            ...
            <div class="mt-1 flex gap-3 items-center">
               ...
               <p class="text-zinc-500">@ {{ $item->product->formattedPrice() }}</p>
               <p class="font-semibold text-zinc-600">{{ $item->formattedTotal() }}</p>
            </div>
         </div>
   ...
   <div class="mt-6 flex justify-between items-center">
      ...
      <p class="text-3xl font-black">{{ $cart->formattedTotal() }}</p>
   </div>
   ...
   <div popover id="confirm-order" class="bg-transparent m-auto backdrop:bg-zinc-900/50 backdrop:backdrop-blur-sm">
      <div class="bg-white p-8 rounded-lg w-120 max-w-full">
         ...
         <div class="mt-6 flex justify-between items-center">
            <p class="text-sm text-zinc-500">Order Total</p>
            <p class="text-xl font-black">{{ $cart->formattedTotal() }}</p>
         </div>
